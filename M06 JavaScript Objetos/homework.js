...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var newObjects = {nombre: nombre, edad: edad};
   newObjects.meow = function (){
      return 'Meow!';
   }
   return newObjects;
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Tu código:
   var newObjects = {};
   newObjects.nombre = nombre;
   newObjects.email = email;
   newObjects.password = password;
   return newObjects;
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   var newNumero = objetoMisterioso.numeroMisterioso * 5;
   return newNumero;
}
...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar True. Caso contrario, False.
   // Tu código:
   var siEsta = objeto.hasOwnProperty(propiedad);
   return siEsta;
}
